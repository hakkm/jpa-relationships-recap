...
public class JoinedTableInheritance {
  /*
   * Tests Joined Table Inheritance
   * Separate tables for each class
   * Person(id, dtype, name), Student(id, grade), Teacher(id, salary)
   */
  ...
  @BeforeEach
  public void setUp() {
    emf = Persistence.createEntityManagerFactory("defaultPUJoinedTableInheritance",
